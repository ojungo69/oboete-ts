...
- [ ] T042 Measure 1,000/10,000/100,000-event resources and seven days of real use with `src/fixture/replay.ts`
  ...
  `docs/evidence/memory-core-2026-09/resource-sweep.md`): peak `VmHWM` 107.46 / 100.44 MiB across every process of the run against a
...
- T042 (open, 2026-09-21): the retained-history resource sweep is measured and recorded; the scale legs
  ...
  the resident worker, a hold of a read-only connection of at least 20 seconds (27.4 s measured) while 20 sessions keep capturing. Four gated checks pass on Node
  ...
  exit rather than by sampling. Injection p99 (286.4 ms) and the two
