...
5. **実測と最終 gate**: T020 (2026-09-17 に合成テストで close、native は #265)、T023 (2026-09-21 close。#275 は #304、receipt は E18。MMR の深さ依存 #272 は同一内容だけを落とす形に直し、receipt は E19)、T024 (#266。2026-09-21 に gemma4:12b と Workers AI を試し、どの profile も合格せず。E20、#328、#329)、
   T041–T045。実 agent pair・実モデル・100k events・7 日運用は merge 後の follow-up issue + dogfood cron で追う (owner 判断)。
   T042 は 1,000 events と 10,000 events (#332 後に両 Node 版で全 gate 合格) の retained-history sweep が close 相当 (`scripts/measure-resources.mjs`、
   ...
   WAL は held reader 下で伸びて stop 後に 0、spool 0、hook は全件 exit 0)。100,000 events は #267、
